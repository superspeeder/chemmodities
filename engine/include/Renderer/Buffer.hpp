...
namespace che {
    ...
    class VertexBuffer : public DebuggableObject, public che::Disposable {
    private:
        GLbuffer m_BufferID;
    ...
    public:
        ...
        inline void clear() { m_BufferData.clear(); };
    ...
    class IndexBuffer : public DebuggableObject, public che::Disposable {
    private:
        GLbuffer m_BufferID;
        GLuint m_CurrentBufferSize;
    ...
    class VertexArray : public che::Disposable {
    private:
        GLbuffer m_VertexArrayID;
    ...
    public:
        ...
        void pushAttribute(VertexAttribute attribute, bool enable);
        
        void enableAttribute(unsigned int attributeIndex);
        void disableAttribute(unsigned int attributeIndex);
